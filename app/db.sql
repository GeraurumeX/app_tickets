...
BEGIN
    ...
    START TRANSACTION;
        ...
        IF existe_registro = 1 THEN
            ...
            SELECT 'Tu correo eléctronico ya ha sido registrado previamente, sólo puedes registrarte una vez.' AS respuesta;
...
/* CALL registrar_participante('test1@hotmail.com', 'Prueba 1', 'Test',  '1972-10-03', '1k');
CALL registrar_participante('test2@hotmail.com', 'Prueba 2', 'Test',  '1972-10-03', '1k');
CALL registrar_participante('test3@hotmail.com', 'Prueba 3', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test4@hotmail.com', 'Prueba 4', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test5@hotmail.com', 'Prueba 5', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test6@hotmail.com', 'Prueba 6', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test7@hotmail.com', 'Prueba 7', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test8@hotmail.com', 'Prueba 8', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test9@hotmail.com', 'Prueba 9', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test10@hotmail.com', 'Prueba 10', 'Test', '1972-10-03', '1k');
CALL registrar_participante('test11@hotmail.com', 'Prueba 11', 'Agustin',  '1972-10-03', '1Y');
CALL eliminar_participante('test11@hotmail.com');